...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "rejected", element: <DashboardLayout />, children: [{ index: true, element: <GmTrackingPanel mode="rejected" /> }] },
      { path: "disbursed", element: <DashboardLayout />, children: [{ index: true, element: <GmTrackingPanel mode="disbursed" /> }] },
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "rejected", element: <FinanceDeskPanel mode="rejected" /> },
          { path: "disbursed", element: <FinanceDeskPanel mode="disbursed" /> },
          ...
          { path: "approved", element: <Navigate to="/finance/status?status=UNDER_BANK_PROCESS" replace /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "rejected", element: <DashboardLayout />, children: [{ index: true, element: <BankBranchManagerPanel mode="rejected" /> }] },
      { path: "disbursed", element: <DashboardLayout />, children: [{ index: true, element: <BankBranchManagerPanel mode="disbursed" /> }] },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "rejected", element: <DashboardLayout />, children: [{ index: true, element: <LoanExecutivePanel mode="rejected" /> }] },
      { path: "disbursed", element: <DashboardLayout />, children: [{ index: true, element: <LoanExecutivePanel mode="disbursed" /> }] },
