...
function BankBranchSelector({ banks, formData, handleInputChange, loadingBanks, onConfigureBanks }) {
  return (
...
function SalespersonSelector({ formData, handleInputChange, loadingSalespersons, salespersons }) {
  return (
    <div className="md:col-span-2">
      <label className="block text-sm font-medium text-gray-700 mb-2">
