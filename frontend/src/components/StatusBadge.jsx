...
export function StatusBadge({ status }) {
  ...
  return (
    <span className={`inline-flex max-w-full items-center rounded-full px-2 py-0.5 text-[11px] font-semibold leading-4 ring-1 ${tone[normalized] || tone[LEAD_STATUSES.NEW]}`}>
