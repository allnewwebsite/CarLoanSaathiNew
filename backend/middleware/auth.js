...
export async function authenticate(req, res, next) {
  ...
  try {
    ...
    req.user = {
      ...
      branchIfsc: account.branchIfsc || account.bankIfsc || account.ifscCode || account.branchId || null,
      bankIfsc: account.bankIfsc || account.branchIfsc || account.ifscCode || account.branchId || null,
      ifscCode: account.ifscCode || account.branchIfsc || account.bankIfsc || account.branchId || null,
      branchCity: account.branchCity || account.branchLocation || account.bankBranchLocation || account.bankBranchCity || null,
      branchLocation: account.branchLocation || account.bankBranchLocation || account.branchCity || account.bankBranchCity || null,
