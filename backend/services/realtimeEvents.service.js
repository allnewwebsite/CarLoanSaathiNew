...
const DETAILED_REALTIME_EVENT_REGISTRY = Object.freeze({
  ...
  [REALTIME_EVENTS.NOTIFICATION_UPDATED]: eventDefinition({
    eventType: REALTIME_EVENTS.NOTIFICATION_UPDATED,
    module: "notifications",
    description: "A persisted browser notification changed.",
    roles: ROLE_GROUPS.notification,
    scopes: ["dealershipIds", "bankIds", "executiveIds", "recipientIds"],
    payload: ["notification"],
    patches: ["notification-list", "unread-counter"],
  }),
  [REALTIME_EVENTS.NOTIFICATION_READ]: eventDefinition({
    eventType: REALTIME_EVENTS.NOTIFICATION_READ,
    module: "notifications",
    description: "A browser notification was marked read.",
    roles: ROLE_GROUPS.notification,
    scopes: ["dealershipIds", "bankIds", "executiveIds", "recipientIds"],
    payload: ["notification"],
    patches: ["notification-list", "unread-counter"],
  }),
  [REALTIME_EVENTS.NOTIFICATION_MARK_ALL_READ]: eventDefinition({
    eventType: REALTIME_EVENTS.NOTIFICATION_MARK_ALL_READ,
    module: "notifications",
    description: "All visible browser notifications were marked read for one recipient scope.",
    roles: ROLE_GROUPS.notification,
    scopes: ["dealershipIds", "bankIds", "executiveIds", "recipientIds"],
