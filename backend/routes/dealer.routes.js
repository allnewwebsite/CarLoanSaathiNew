...
router.post("/register", registrationRateLimit, registerDealerOnboarding);
router.post("/register/email-start", registrationRateLimit, startDealerRegistration);
router.post("/register/status", registrationRateLimit, getDealerRegistrationStatus);
