...
test("Firestore indexes include scale-critical projection list contracts", () => {
  ...
  [
    ...
    "financeViews:viewType:ASCENDING|scopeId:ASCENDING|workflowLocation:ASCENDING|createdAt:DESCENDING",
    "gmViews:viewType:ASCENDING|scopeId:ASCENDING|workflowLocation:ASCENDING|createdAt:DESCENDING",
    "bankViews:viewType:ASCENDING|scopeId:ASCENDING|workflowLocation:ASCENDING|createdAt:DESCENDING",
    "executiveViews:viewType:ASCENDING|scopeId:ASCENDING|workflowLocation:ASCENDING|createdAt:DESCENDING",
